...
describe Resource do
  ...
  let(:resource) { Resource::Mock.new(valid_attributes) }
  let(:invalid_resource) { Resource::Mock.new(invalid_attributes) }

  describe "validation" do

    it "is valid with required attributes" do
      resource = Resource::Mock.new(valid_attributes)
    ...
    it "is invalid without required attributes" do
      invalid_resource = Resource::Mock.new(invalid_attributes)
  ...
  describe "type conversion" do
    ...
    describe ".from_hash" do
      it "converts a Hash into a Resource object" do
        resource = Resource.from_hash(resource_hash)
        resource.name.should == "foo"
        resource.message.should == "Running!"
    ...
    describe "#to_s" do
      it "returns a String" do
        resource.to_s.should == "resource[mock::foo]"
      end
    end
  end
  ...
  describe "attributes" do
    describe "#provider" do
      it "returns the class of the resource's provider" do
        resource.provider.should == Provider::Mock
      end
    end
